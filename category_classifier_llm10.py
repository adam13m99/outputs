...
INPUT_FILE = "pish.csv"
OUTPUT_FILE = "pish_new.csv"
TAXONOMY_FILE = "category_definitions_2_new.json"

CONFIG: Dict[str, Any] = {
    # --- Gemini (match validator config) ---
    "GEMINI_API_KEY": os.getenv("GENAI_API_KEY", "AIzaSyBNsVf1-xeCJxbyxnVVmB6QvnnVZYF-1fk"),  # REQUIRED
